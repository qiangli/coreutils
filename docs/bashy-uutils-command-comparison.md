...
| Misc / extended | `coreutils` | `act`, `act-runner`, `agent`, `ast`, `browser`, `chat`, `check`, `commands`, `context`, `dag`, `docker`, `doctl`, `doctor`, `fetch`, `foreman`, `gh`, `git`, `graph`, `helm`, `kopia`, `kubectl`, `login`, `loom`, `mirror`, `ollama`, `podman`, `rclone`, `run`, `schedule`, `sdlc`, `seaweedfs`, `secrets`, `self`, `skills`, `sphere`, `sprint`, `tessaro`, `verify`, `weave`, `web`, `zot` |
...
`act`, `act-runner`, `agent`, `browser`, `chat`, `check`, `commands`, `context`, `dag`, `docker`, `doctl`, `doctor`, `fetch`, `foreman`, `gh`, `git`, `graph`, `helm`, `kopia`, `kubectl`, `login`, `loom`, `mirror`, `ollama`, `podman`, `rclone`, `run`, `schedule`, `sdlc`, `seaweedfs`, `secrets`, `self`, `skills`, `sphere`, `sprint`, `tessaro`, `verify`, `weave`, `web`, `zot`
