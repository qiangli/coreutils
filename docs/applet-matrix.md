...
| `browser` | `cmds/browser` | — | Bashy/other extension | no | no | 1 | 17 |
...
| `nohup` | `cmds/nohup` | — | GNU Coreutils | yes | yes | 4 | 27 |
...
| `pax` | `cmds/pax` | — | POSIX/Unix utility | no | yes | 17 | 199 |
...
| `pwd` | `cmds/pwd` | — | GNU Coreutils | yes | yes | 2 | 12 |
...
| `write` | `cmds/write` | — | POSIX/Unix utility | no | yes | 6 | 86 |
