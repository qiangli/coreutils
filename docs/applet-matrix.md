...
| `awk` | `cmds/awk` | — | POSIX/Unix utility | no | yes | 3 | 47 |
...
| `ctags` | `cmds/posixproviders` | — | POSIX external provider | no | yes | 4 | 24 |
...
| `ex` | `cmds/posixproviders` | — | POSIX external provider | no | yes | 4 | 24 |
...
| `localedef` | `cmds/posixproviders` | — | POSIX external provider | no | yes | 4 | 24 |
| `logger` | `cmds/logger` | — | POSIX/Unix utility | no | yes | 3 | 32 |
| `logname` | `cmds/logname` | — | GNU Coreutils | yes | yes | 2 | 10 |
| `lp` | `cmds/posixproviders` | — | POSIX external provider | no | yes | 4 | 24 |
| `ls` | `cmds/ls` | — | GNU Coreutils | yes | yes | 5 | 69 |
| `m4` | `cmds/posixproviders` | — | POSIX external provider | no | yes | 4 | 24 |
...
| `man` | `cmds/posixproviders` | — | POSIX external provider | no | yes | 4 | 24 |
...
| `nm` | `cmds/posixproviders` | — | POSIX external provider | no | yes | 4 | 24 |
...
| `posix-providers` | `cmds/posixproviders` | — | Bashy/other extension | no | no | 4 | 24 |
...
| `tail` | `cmds/tail` | — | GNU Coreutils | yes | yes | 4 | 30 |
...
| `uniq` | `cmds/uniq` | — | GNU Coreutils | yes | yes | 3 | 14 |
