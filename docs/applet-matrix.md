...
| `at` | `cmds/at` | — | POSIX/Unix utility | no | yes | 5 | 23 |
...
| `batch` | `cmds/batch` | — | POSIX/Unix utility | no | yes | 1 | 7 |
...
| `chgrp` | `cmds/chgrp` | — | GNU Coreutils | yes | yes | 3 | 25 |
| `chmod` | `cmds/chmod` | — | GNU Coreutils | yes | yes | 2 | 20 |
| `chown` | `cmds/chown` | — | GNU Coreutils | yes | yes | 3 | 25 |
...
| `cp` | `cmds/cp` | — | GNU Coreutils | yes | yes | 4 | 44 |
...
| `mkfifo` | `cmds/mkfifo` | — | GNU Coreutils | yes | yes | 2 | 12 |
...
| `pax` | `cmds/pax` | — | POSIX/Unix utility | no | yes | 4 | 67 |
...
| `write` | `cmds/write` | — | POSIX/Unix utility | no | yes | 4 | 79 |
| `xargs` | `cmds/xargs` | — | POSIX/Unix utility | no | yes | 3 | 41 |
