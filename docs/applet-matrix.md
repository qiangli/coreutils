...
| `awk` | `cmds/awk` | — | POSIX/Unix utility | no | yes | 1 | 4 |
...
| `comm` | `cmds/comm` | — | GNU Coreutils | yes | yes | 1 | 9 |
| `cp` | `cmds/cp` | — | GNU Coreutils | yes | yes | 3 | 30 |
| `crontab` | `cmds/crontab` | — | POSIX/Unix utility | no | yes | 1 | 10 |
...
| `diff` | `cmds/diff` | — | POSIX/Unix utility | no | yes | 2 | 34 |
...
| `ls` | `cmds/ls` | — | GNU Coreutils | yes | yes | 2 | 36 |
...
| `nohup` | `cmds/nohup` | — | GNU Coreutils | yes | yes | 3 | 18 |
...
| `sort` | `cmds/sort` | — | GNU Coreutils | yes | yes | 3 | 18 |
...
| `stty` | `cmds/stty` | — | GNU Coreutils | yes | yes | 2 | 9 |
...
| `tr` | `cmds/tr` | — | GNU Coreutils | yes | yes | 1 | 7 |
