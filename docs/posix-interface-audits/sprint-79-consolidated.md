...
> availability 92 Go / 14 shell / 10 external provider and effective selection
> 84 Go / 22 shell / 10 external provider; `ed`, `patch`, `mailx`, `talk`, `bc`,
> and `make` moved to Go applets. See `../posix-required-commands.md` for current
> counts.
