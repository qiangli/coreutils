...
message catalogs. Two of the five (`comm`, `csplit`, `cut`, `expand`) also
retain a genuine locale-category implementation gap named below; `dirname`
retains only the catalog residual. The command-specific residuals table makes
