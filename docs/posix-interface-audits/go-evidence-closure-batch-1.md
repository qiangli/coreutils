...
| `cat` | [Issue 7 cat](https://pubs.opengroup.org/onlinepubs/9699919799.2016edition/utilities/cat.html) | partial | Locale diagnostics remain absent; injected input-read failure and broader special-file evidence are not yet stable. Repeated `-` now proves one continuing stdin stream. |
