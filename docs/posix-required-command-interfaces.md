...
**Environment:** `LANG; LC_ALL; LC_COLLATE; LC_CTYPE; LC_MESSAGES; LC_NUMERIC; xsi:NLSPATH; PATH. ENVIRON receives invocation variables;  LC_CTYPE and LC_COLLATE are wired for regex character classes/equivalence in the evidenced public locale path. LC_NUMERIC follows invocation precedence and supports the carried C/POSIX and de_DE decimal-radix products;  arbitrary installed locales remain outside the bounded provider.`.
...
**Environment:** `LANG; LC_ALL; LC_COLLATE; LC_CTYPE; LC_MESSAGES; xsi:NLSPATH. C/POSIX and carried single-byte locale comparison, character-class, range, equivalence, and BRE back-reference semantics are evidenced;  arbitrary installed and multibyte locale breadth remains residual.`.
...
**Evidence lanes:** Go=`cmds/join/join_test.go#TestJoin;cmds/join/join_test.go#TestJoinStdin;cmds/join/join_test.go#TestJoinOrderCheck;cmds/join/join_test.go#TestJoinPOSIXOutputListAndUnpairableAggregation;cmds/join/join_test.go#TestJoinPOSIXFieldSeparators;cmds/join/join_test.go#TestJoinPOSIXOperandArityAndStderr;cmds/join/collate_test.go#TestJoinCPOSIXAndIgnoreCaseBypassCollator;cmds/join/collate_test.go#TestJoinLCCollateCloseFailureDiscardsOutput;cmds/join/collate_test.go#TestJoinLCCollateCompareFailureIsDiagnosed;cmds/join/collate_test.go#TestJoinLCCollateFlagsCollationDisorder;cmds/join/collate_test.go#TestJoinLCCollateOpenFailurePrecedesInput;cmds/join/collate_test.go#TestJoinLCCollateOrdersFieldComparison`; shell semantic=`-`; shell routing=`-`; provider=`-`; clauses=`XCU:join:SYNOPSIS,OPTIONS,OPERANDS,ENVIRONMENT_VARIABLES,STDIN,INPUT_FILES,STDOUT,STDERR,OUTPUT_FILES,EXIT_STATUS,CONSEQUENCES_OF_ERRORS`.
...
**Evidence lanes:** Go=`cmds/ls/ls_test.go#TestDefaultSortAndOnePerLine;cmds/ls/ls_test.go#TestMixedOperandsHeaders;cmds/ls/ls_test.go#TestLongFormat;cmds/ls/ls_test.go#TestAllAndAlmostAll;cmds/ls/ls_test.go#TestDirectoryFlag;cmds/ls/ls_test.go#TestRecursive;cmds/ls/ls_test.go#TestReverse;cmds/ls/ls_test.go#TestSortTime;cmds/ls/ls_test.go#TestSortSize;cmds/ls/ls_test.go#TestInode;cmds/ls/ls_test.go#TestNonexistentOperand;cmds/ls/ls_posix_test.go#TestCommaFormatNoTrailingSeparator;cmds/ls/ls_posix_test.go#TestCommaFormatWrapsAtWidth;cmds/ls/ls_posix_test.go#TestColumnsDown;cmds/ls/ls_posix_test.go#TestColumnsAcross;cmds/ls/ls_posix_test.go#TestColumnsHonorsColumnsEnv;cmds/ls/ls_posix_test.go#TestHideControlChars;cmds/ls/ls_posix_test.go#TestSizeBlocksShortFormat;cmds/ls/ls_posix_test.go#TestDereferenceDirectoryEntries;cmds/ls/ls_posix_test.go#TestOrderIndicatorClassifyAndSlash;cmds/ls/ls_posix_test.go#TestSizeBlocksPOSIX512ByteDefault;cmds/ls/ls_locale_test.go#TestLsLocaleCollationPrecedence;cmds/ls/ls_locale_test.go#TestLsLocaleCTypePrecedenceForQuestionMark;cmds/ls/ls_posix_test.go#TestLsDoubleDashTerminatesOptions;cmds/ls/ls_posix_test.go#TestLsDereferenceCommandLineSymlinks;cmds/ls/ls_posix_test.go#TestLsDereferenceModeLastOptionWins`; shell semantic=`-`; shell routing=`-`; provider=`-`; clauses=`XCU:ls:SYNOPSIS,OPTIONS,OPERANDS,ENVIRONMENT_VARIABLES,STDIN,INPUT_FILES,STDOUT,STDERR,OUTPUT_FILES,EXIT_STATUS,CONSEQUENCES_OF_ERRORS`.
...
**Evidence lanes:** Go=`cmds/mailx/mailx_test.go#TestSendDeliversMboxToEachLocalRecipient;cmds/mailx/mailx_test.go#TestRemoteRecipientFailsBeforeAnyDelivery;cmds/mailx/mailx_test.go#TestExistAndHeadersModes;cmds/mailx/mailx_test.go#TestDeleteQuitRewritesMailbox;cmds/mailx/mailx_test.go#TestDeleteQuitPreservesConcurrentAppend;cmds/mailx/mailx_test.go#TestFileOptionWithoutOperandReadsMBOX;cmds/mailx/mailx_test.go#TestFileOptionConsumesExplicitOperand;cmds/mailx/mailx_test.go#TestRecordByFirstRecipient;cmds/mailx/mailx_test.go#TestMailAliasIsExecutable;cmds/mailx/posix_session_test.go#TestPOSIXStartupAliasesAndNoSystemRC;cmds/mailx/posix_session_test.go#TestPOSIXReadDispositionMovesToMBOXAndAgesNewMail;cmds/mailx/posix_session_test.go#TestPOSIXMessageSelectorsAndStateCommands;cmds/mailx/posix_session_test.go#TestPOSIXComposeEscapesUpdateEnvelopeAndBody;cmds/mailx/posix_session_test.go#TestCommitMboxChangesPreservesConcurrentAppend;cmds/mailx/posix_session_test.go#TestPOSIXMailboxSpecialNamesAndMBOXPrepend;cmds/mailx/posix_session_test.go#TestPOSIXCompositionInterruptAndIgnore;cmds/mailx/posix_session_test.go#TestPOSIXCommandMinimumAbbreviations;cmds/mailx/posix_session_test.go#TestPOSIXKeepAndNoKeepEmptyMailboxDisposition;cmds/mailx/posix_session_test.go#TestPOSIXPreserveSurvivesReadAndAgesStatus;cmds/mailx/posix_session_test.go#TestPOSIXPromptFolderAndDisabledEscape`; shell semantic=`-`; shell routing=`-`; provider=`-`; clauses=`XCU:mailx:SYNOPSIS,OPTIONS,OPERANDS,ENVIRONMENT_VARIABLES,STDIN,INPUT_FILES,STDOUT,STDERR,OUTPUT_FILES,EXIT_STATUS,CONSEQUENCES_OF_ERRORS`.
...
**Evidence lanes:** Go=`cmds/sort/sort_test.go#TestOpenOperandsValidatesAllBeforeReading;cmds/sort/sort_test.go#TestSortBasic;cmds/sort/sort_test.go#TestSortKeys;cmds/sort/sort_test.go#TestSortCheck;cmds/sort/sort_test.go#TestSortFilesAndOutput;cmds/sort/sort_test.go#TestSortMerge;cmds/sort/sort_test.go#TestSortLCNumeric;cmds/sort/collator_test.go#TestRunWithCollatorOrdersTextualComparisons;cmds/sort/ctype_test.go#TestSortCPOSIXNeverOpensCtype;cmds/sort/ctype_test.go#TestSortLCCTypeDictKeepsHighByteAlnum;cmds/sort/ctype_test.go#TestSortLCCTypeFoldOrdersAcrossCase;cmds/sort/ctype_test.go#TestSortLCCTypeFoldsHighByteLetters;cmds/sort/ctype_test.go#TestSortLCCTypeIgnoreNPDropsNonPrint;cmds/sort/ctype_test.go#TestSortLCCTypeSnapshotFailurePrecedesOutput;cmds/sort/ctype_test.go#TestSortLCCTypeUnsupportedFailsClosed;cmds/sort/ctype_test.go#TestSortNoTextKeyNeverOpensCtype`; shell semantic=`-`; shell routing=`-`; provider=`-`; clauses=`XCU:sort:SYNOPSIS,OPTIONS,OPERANDS,ENVIRONMENT_VARIABLES,STDIN,INPUT_FILES,STDOUT,STDERR,OUTPUT_FILES,EXIT_STATUS,CONSEQUENCES_OF_ERRORS`.
...
**Special tokens:** -c/-n numbers take an optional sign with origin 1: +N copies from byte/line N onward (the N-1 skip is performed by reading, so it works on non-seekable input), unsigned or -N copies the last N; multiplier suffixes (b, K, KiB, kB, ...) are accepted as extensions; a leading -NUM first argument is rewritten to -n NUM, and the historical -NUMc/-NUMl forms select bytes/lines respectively (obsolescent-form extensions retained), while +NUM is an ordinary pathname (Issue 7 removed the obsolescent plus form); -- ends option parsing and - means standard input.
...
**Evidence lanes:** Go=`cmds/tr/tr_test.go#TestTrTranslate;cmds/tr/tr_test.go#TestTrDeleteSqueeze;cmds/tr/tr_test.go#TestTrOperandErrors;cmds/tr/tr_test.go#TestTrClasses;cmds/tr/tr_test.go#TestTrInputReadErrorIsReported;cmds/tr/tr_test.go#TestTrEPIPE;cmds/tr/ctype_test.go#TestCTypeProviderBacked;cmds/tr/ctype_test.go#TestCTypeCaseTranslation;cmds/tr/locale_test.go#TestTrPOSIXLocalePrecedenceSelectsCTypeCategory;cmds/tr/locale_test.go#TestTrPOSIXMultibyteCaseTranslation;cmds/tr/locale_test.go#TestTrPOSIXMultibyteCharacterBoundaries;cmds/tr/locale_test.go#TestTrPOSIXMultibyteClasses;cmds/tr/locale_test.go#TestTrPOSIXMultibyteComplement;cmds/tr/locale_test.go#TestTrPOSIXMultibyteOctalEscapesAreBytes;cmds/tr/locale_test.go#TestTrPOSIXMultibytePreservesUninterpretableBytes;cmds/tr/locale_test.go#TestTrPOSIXMultibyteRanges;cmds/tr/locale_test.go#TestTrPOSIXMultibyteRepeatAndTruncate;cmds/tr/locale_test.go#TestTrUTF8LocaleIsUsable;cmds/tr/collate_test.go#TestTrLCCollateRangesAndEquivalence;cmds/tr/collate_test.go#TestTrLCCollatePrecedence;cmds/tr/collate_test.go#TestTrLCCollateFailsClosed;cmds/tr/locale_test.go#TestTrPOSIXValueAndCharacterComplementsDiffer;cmds/tr/locale_test.go#TestTrPOSIXValueComplementSqueezesPostTransformCharacters;cmds/tr/collate_test.go#TestTrCharacterComplementUsesCTypeDomainAndCollateOrder`; shell semantic=`-`; shell routing=`-`; provider=`-`; clauses=`XCU:tr:SYNOPSIS,OPTIONS,OPERANDS,ENVIRONMENT_VARIABLES,STDIN,INPUT_FILES,STDOUT,STDERR,OUTPUT_FILES,EXIT_STATUS,CONSEQUENCES_OF_ERRORS`.
...
**Evidence lanes:** Go=`cmds/tsort/tsort_test.go#TestTsort;cmds/tsort/tsort_test.go#TestTsortLoop;cmds/tsort/tsort_test.go#TestTsortFileOperand;cmds/tsort/tsort_test.go#TestTsortErrors;cmds/tsort/tsort_test.go#TestTsortPOSIXExample;cmds/tsort/tsort_test.go#TestTsortIssue7BlankSeparatorsAreExact;cmds/tsort/tsort_test.go#TestTsortIssue7StreamFailures;cmds/tsort/tsort_test.go#TestTsortIssue7InputCloseFailure;cmds/tsort/tsort_test.go#TestTsortExtensionsRemainAvailableWithPOSIXEnvironment;cmds/tsort/tsort_test.go#TestTsortIssue7StdinNotUsedWithFileOperand;cmds/tsort/tsort_test.go#TestTsortIssue7OptionTerminator`; shell semantic=`-`; shell routing=`-`; provider=`-`; clauses=`XCU:tsort:SYNOPSIS,OPTIONS,OPERANDS,ENVIRONMENT_VARIABLES,STDIN,INPUT_FILES,STDOUT,STDERR,OUTPUT_FILES,EXIT_STATUS,CONSEQUENCES_OF_ERRORS`.
...
**Evidence lanes:** Go=`cmds/uname/uname_test.go#TestUnameDefaultIsKernelName;cmds/uname/uname_test.go#TestUnameFields;cmds/uname/uname_test.go#TestUnameCombinedAndAll;cmds/uname/uname_test.go#TestUnameAllIsExactlyMNRSV;cmds/uname/uname_test.go#TestUnameErrors;cmds/uname/uname_test.go#TestUnameIssue7SelectorCompositionAndOrder;cmds/uname/uname_test.go#TestUnameIssue7ProviderAndOutputFailures;cmds/uname/uname_test.go#TestUnameExtensionsRemainAvailableWithPOSIXEnvironment;cmds/uname/uname_assemble_test.go#TestAssembleSkipsSyntheticEmptyVersion;cmds/uname/uname_assemble_test.go#TestAssembleFixedOrderWithVersion;cmds/uname/uname_test.go#TestUnameIssue7OptionTerminatorAndSelectorOrder`; shell semantic=`-`; shell routing=`-`; provider=`-`; clauses=`XCU:uname:SYNOPSIS,OPTIONS,OPERANDS,ENVIRONMENT_VARIABLES,STDIN,INPUT_FILES,STDOUT,STDERR,OUTPUT_FILES,EXIT_STATUS,CONSEQUENCES_OF_ERRORS`.
...
**Evidence lanes:** Go=`cmds/uniq/uniq_test.go#TestUniq;cmds/uniq/uniq_test.go#TestUniqPOSIXCCharacterUnits;cmds/uniq/uniq_test.go#TestUniqPOSIXRequiresPositiveSkipArguments;cmds/uniq/uniq_test.go#TestUniqOperands;cmds/uniq/uniq_test.go#TestUniqErrors;cmds/uniq/locale_test.go#TestUniqLocaleProviderFailuresAreDiagnosed;cmds/uniq/locale_test.go#TestUniqPOSIXCLocaleOpensNoProvider;cmds/uniq/locale_test.go#TestUniqPOSIXMultibyteFieldsUseLocaleBlanks;cmds/uniq/locale_test.go#TestUniqPOSIXMultibyteSkipsCharacters;cmds/uniq/locale_test.go#TestUniqPOSIXSingleByteLocaleUsesProviderAndPrecedence;cmds/uniq/locale_test.go#TestUniqPOSIXSkipsPastEndOfLineCompareNullString`; shell semantic=`-`; shell routing=`-`; provider=`-`; clauses=`XCU:uniq:SYNOPSIS,OPTIONS,OPERANDS,ENVIRONMENT_VARIABLES,STDIN,INPUT_FILES,STDOUT,STDERR,OUTPUT_FILES,EXIT_STATUS,CONSEQUENCES_OF_ERRORS`.
