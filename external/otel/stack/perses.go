...
import (
	...
	"github.com/qiangli/coreutils/external/otel/stack/dashboards"
	"github.com/qiangli/coreutils/external/otel/stack/plugins"

	ociPerses "github.com/qiangli/coreutils/external/otel/perses"
)
...
func provisionPluginArchives(destDir string) {
	...
	candidates := []string{
		filepath.Join(home, ".agents", "otel", "perses", "plugins-archive"),
	}
