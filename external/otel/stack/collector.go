...
import (
	...
	oc "github.com/qiangli/coreutils/external/otel/collector"
)
...
func (c *EmbeddedCollector) Start(ctx context.Context) error {
	...
	settings := oc.CollectorSettings{
		BuildInfo: oc.BuildInfo{
			...
			Description: "Embedded OTEL Collector",
			Version:     "0.1.0",
		},
...
<div class="row"><span class="label">Command</span><span class="value">otel-collector</span></div>
