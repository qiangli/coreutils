...
// systemInventoryNames is deliberately separate from values. It contains the
// POSIX.1-2016 mandatory spellings plus established numerical-limit extensions.
// A known spelling is permitted to be undefined: manufacturing a number is
// worse than saying the platform cannot determine it without libc.
var systemInventoryNames = []string{
...
var compatibilityAliases = map[string]string{
	"POSIX2_C_BIND": "_POSIX2_C_BIND", "POSIX2_C_DEV": "_POSIX2_C_DEV",
	"POSIX2_CHAR_TERM": "_POSIX2_CHAR_TERM", "POSIX2_FORT_DEV": "_POSIX2_FORT_DEV",
	"POSIX2_FORT_RUN": "_POSIX2_FORT_RUN", "POSIX2_LOCALEDEF": "_POSIX2_LOCALEDEF",
	"POSIX2_SW_DEV": "_POSIX2_SW_DEV", "POSIX2_UPE": "_POSIX2_UPE",
	"POSIX2_VERSION":     "_POSIX2_VERSION",
	"POSIX2_BC_BASE_MAX": "_POSIX2_BC_BASE_MAX", "POSIX2_BC_DIM_MAX": "_POSIX2_BC_DIM_MAX",
	"POSIX2_BC_SCALE_MAX": "_POSIX2_BC_SCALE_MAX", "POSIX2_BC_STRING_MAX": "_POSIX2_BC_STRING_MAX",
	"POSIX2_COLL_WEIGHTS_MAX": "_POSIX2_COLL_WEIGHTS_MAX", "POSIX2_EXPR_NEST_MAX": "_POSIX2_EXPR_NEST_MAX",
	"POSIX2_LINE_MAX": "_POSIX2_LINE_MAX", "POSIX2_RE_DUP_MAX": "_POSIX2_RE_DUP_MAX",
}

var standardMinimumValues = map[string]int64{
	"_POSIX_CLOCKRES_MIN":   20000000,
	"_POSIX_AIO_LISTIO_MAX": 2, "_POSIX_AIO_MAX": 1, "_POSIX_ARG_MAX": 4096,
	"_POSIX_CHILD_MAX": 25, "_POSIX_DELAYTIMER_MAX": 32, "_POSIX_HOST_NAME_MAX": 255,
	"_POSIX_LINK_MAX": 8, "_POSIX_LOGIN_NAME_MAX": 9, "_POSIX_MAX_CANON": 255,
	"_POSIX_MAX_INPUT": 255, "_POSIX_MQ_OPEN_MAX": 8, "_POSIX_MQ_PRIO_MAX": 32,
	"_POSIX_NAME_MAX": 14, "_POSIX_NGROUPS_MAX": 8, "_POSIX_OPEN_MAX": 20,
	"_POSIX_PATH_MAX": 256, "_POSIX_PIPE_BUF": 512, "_POSIX_RE_DUP_MAX": 255,
	"_POSIX_RTSIG_MAX": 8, "_POSIX_SEM_NSEMS_MAX": 256, "_POSIX_SEM_VALUE_MAX": 32767,
	"_POSIX_SIGQUEUE_MAX": 32, "_POSIX_SSIZE_MAX": 32767, "_POSIX_SS_REPL_MAX": 4,
	"_POSIX_STREAM_MAX": 8, "_POSIX_SYMLINK_MAX": 255, "_POSIX_SYMLOOP_MAX": 8,
	...
	"_POSIX2_EXPR_NEST_MAX": 32, "_POSIX2_LINE_MAX": 2048, "_POSIX2_RE_DUP_MAX": 255,
	"_XOPEN_IOV_MAX": 16, "_XOPEN_NAME_MAX": 255, "_XOPEN_PATH_MAX": 1024,
}
...
func init() {
	...
	for name, value := range standardMinimumValues {
		sysVars[name] = constVal(value)
	}
	for alias := range compatibilityAliases {
		// The value is resolved through compatibilityAliases in systemValue;
		// registering the spelling also makes the -a extension complete.
		sysVars[alias] = undefinedVal
	}
	// Removed from the Issue 7 mandatory table but retained as a Darwin local
	// extension because the platform adapter can answer it exactly.
	if _, ok := sysVars["_POSIX_FILE_LOCKING"]; !ok {
		sysVars["_POSIX_FILE_LOCKING"] = undefinedVal
	}
	...
	pathVars["_POSIX_TIMESTAMP_RESOLUTION"] = pcTimestampResolution
}
...
func compileTimeMinimum(name string) bool {
	_, ok := standardMinimumValues[name]
	return ok
}
...
func pathValue(rc *tool.RunContext, name, path string) (string, bool, error) {
