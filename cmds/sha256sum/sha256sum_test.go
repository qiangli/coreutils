...
// sha256("abc") — FIPS 180 test vector.
...
func TestCheck(t *testing.T) {
	...
	if out != "f.txt: FAILED\n" || code != 1 ||
		!strings.Contains(errb, "sha256sum: WARNING: 1 computed checksum did NOT match") {
...
func TestErrors(t *testing.T) {
	...
	if code != 1 || !strings.Contains(errb, "sha256sum: nope.txt: No such file or directory") {
