...
// sha512("abc") — FIPS 180 test vector.
const abcDigest = "ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f"
...
func TestCheck(t *testing.T) {
	...
	if out != "f.txt: FAILED\n" || code != 1 ||
		!strings.Contains(errb, "sha512sum: WARNING: 1 computed checksum did NOT match") {
...
func TestErrors(t *testing.T) {
	...
	if code != 1 || !strings.Contains(errb, "sha512sum: nope.txt: No such file or directory") {
...
func TestHelpAndVersion(t *testing.T) {
	...
	if code != 0 || !strings.Contains(out, "Usage: sha512sum") {
		t.Errorf("--help: code=%d out=%q", code, out)
	}
	out, _, code = runTool(t, "", "", "--version")
	if code != 0 || !strings.Contains(out, "sha512sum") {
