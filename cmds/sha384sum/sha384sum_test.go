...
// sha384("abc") — FIPS 180 test vector.
const abcDigest = "cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7"
...
func TestCheck(t *testing.T) {
	...
	if out != "f.txt: FAILED\n" || code != 1 ||
		!strings.Contains(errb, "sha384sum: WARNING: 1 computed checksum did NOT match") {
...
func TestErrors(t *testing.T) {
	...
	if code != 1 || !strings.Contains(errb, "sha384sum: nope.txt: No such file or directory") {
...
func TestHelpAndVersion(t *testing.T) {
	...
	if code != 0 || !strings.Contains(out, "Usage: sha384sum") {
		t.Errorf("--help: code=%d out=%q", code, out)
	}
	out, _, code = runTool(t, "", "", "--version")
	if code != 0 || !strings.Contains(out, "sha384sum") {
